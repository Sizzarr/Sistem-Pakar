...
CREATE TABLE gejala (
  ...
  kelompok CHAR(1) NOT NULL DEFAULT 'A',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO gejala (kode, nama, kelompok) VALUES
('G-01','Sulit untuk tidur atau sering terbangun di malam hari','A'),
('G-02','Merasa kelelahan atau kurang energi di siang hari','D'),
('G-03','Sulit tidur di malam hari meskipun sangat lelah','A'),
('G-04','Terbangun dengan detak jantung yang cepat atau rasa cemas','A'),
('G-05','Tidak merasa segar meskipun telah tidur cukup lama','A'),
('G-06','Mendengkur keras atau sesak nafas saat tidur','B'),
('G-07','Merasa nafas tersengal-sengal saat bangun tidur','B'),
('G-08','Terbangun dengan rasa tersedak atau sesak nafas','B'),
('G-09','Mendengkur keras dengan jeda nafas panjang','B'),
('G-10','Merasa kantuk berlebihan di siang hari meskipun cukup tidur','D'),
('G-11','Tertidur mendadak tanpa disadari di siang hari','D'),
('G-12','Kesulitan untuk tetap terjaga saat melakukan aktivitas','D'),
('G-13','Mengalami gangguan penglihatan saat merasa kantuk','D'),
('G-14','Kelumpuhan tidur (tidak bisa bergerak saat bangun atau sebelum tidur)','D'),
('G-15','Mengalami sensasi tidak nyaman pada kaki saat tidur','C'),
('G-16','Merasa kesemutan atau ada dorongan untuk menggerakkan kaki saat tidur','C'),
('G-17','Sering merasa kaki pegal atau berat di malam hari','C'),
('G-18','Sering meregangkan kaki secara tidak sadar saat tidur','C'),
('G-19','Mengalami gangguan tidur karena kaki yang sering bergerak','C'),
('G-20','Sulit berkonsentrasi atau fokus di siang hari','D'),
('G-21','Mengalami perubahan suasana hati yang ekstrem di siang hari','D'),
('G-22','Sering merasa marah atau mudah tersinggung di siang hari','D'),
('G-23','Terbangun tiba-tiba dengan rasa cemas','A'),
('G-24','Merasa sulit tidur meskipun kondisi lingkungan mendukung','A');
